...
| `-method <int>`                           | Selects the mathematical metric used to compute pairwise comparisons between elements. Only used with -type data| `1`            | `1` Pearson; `2` Jaccard; `3` Dice; `4` MSD; `5` RMSD; `6` Euclidean; `7` Manhattan.                                                                                                                             |
